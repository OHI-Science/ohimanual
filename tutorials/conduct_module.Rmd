---
title: "OHI Module - How to prepare data and modify goal models"
output: html_document
---

This module will lead you through the process of modifying a goal model. It accompanies a Example-Repo repository with fake data for practice. You can [clone](http://ohi-science.org/manual/#cloning-a-repository-to-your-local-computer) the repo from [https://github.com/OHI-Science/Example-Repo](https://github.com/OHI-Science/Example-Repo). 

Assuming you have gathered raw data and developed goal models, we will work on the next steps towards modifying goal models and calculating goal scores. 

There are x steps: 

1. Check if the template data and functions (2014 Global study) is set up right
1. Prepare data in prep folder
1. Register data in layers.csv
...
## Step 1: Check template data and functions

As a starting point, your tailored repository is populated with data and functions based on global 2014 OHI study, which you can then modify directly. To check that your repository is set up properly, you can check by running `subcountry2016/calculate_scores.R`. It will produce scores for each dimension in subcountry2014/scores.csv. When it’s all set up, you can begin adding your own data and goal models. 

## Step 1: Prepare Data
Data prep is done in `region2015/prep` folder. 
Detailed instructions can also be found in the section in the Manual on [how to format data](http://ohi-science.org/manual/#formatting-data-for-the-toolbox). Assuming you have obtained and formatted the data to the desired format, you will upload them to the `pre-proc` folder for further processing. It is best practice to keep the raw data in their original form, and do any processing with R. That way, the history of how the data has been transformed is captured. 
...
Follow instructions on http://ohi-science.org/manual/#data-layer-preparation to register data layers in layers.csv
