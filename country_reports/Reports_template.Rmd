...
## Global results
As in previous years, this assessment updated datasets and methods to integrate new knowledge and information. The Index Global score for 2016, the Exclusive Economic Zone (EEZ) area weighted average of region (countries and territories) scores was 71. This value did not vary statistically significantly from 2012 to 2016.

## Global Flower Plot

![Global Flower Plot](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/global2016/Reporting/figures/FlowerPlots/flower_GLOBAL_2016.png)
...
## `r country_name` Results
The 2016 Index score for `r country_name` is of `r read_csv(file.path(dir_global, '/data/scores_eez2016.csv')) %>% filter(country == country_name) %>% select(Index)`. Ranking 178 among all countries. 
...
## Table showing 2012-2016 scores
...
## `r country_name` Flower plot

![`r country_name` Flower Plot](https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/global2016/Reporting/figures/FlowerPlots/flower_Colombia_2016.png)
